...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      ...
      <div className='flex-1 flex flex-col justify-star mr-10'>
        <img src={logo} alt="Logo" className='w-[266px] h-[72px] object-contain' />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Uma nova forma de tornar os pagamentos fáceis, confiáveis e seguros.</p>
      </div>
    ...
    <div className='flex w-full justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]'>
      <p className='font-poppins font-normal text-center  text-[18px] leading-[27px] text-white'>
        2022 HooBank. All Rights Reserved. Desenvolvido por <a href='https://www.linkedin.com/in/joaolucascordeiro/' className='text-dimWhite hover:text-secondary'>Lucas Cordeiro ❤</a>
        </p>
